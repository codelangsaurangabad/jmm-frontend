import {
  HttpClient
} from "./chunk-AA2PNKVB.js";
import {
  CommonModule,
  DOCUMENT
} from "./chunk-FX7JNFCW.js";
import {
  ChangeDetectorRef,
  Component,
  ElementRef,
...
// node_modules/angular-svg-icon/fesm2020/angular-svg-icon.mjs
var _c0 = ["*"];
var SvgLoader = class {
};
var SvgHttpLoader = class extends SvgLoader {
  constructor(http) {
    super();
    this.http = http;
  }
...
SvgHttpLoader.ɵfac = function SvgHttpLoader_Factory(t) {
  return new (t || SvgHttpLoader)(ɵɵinject(HttpClient));
};
SvgHttpLoader.ɵprov = ɵɵdefineInjectable({
  token: SvgHttpLoader,
...
var SvgIconRegistryService = class {
...
SvgIconRegistryService.ɵfac = function SvgIconRegistryService_Factory(t) {
  return new (t || SvgIconRegistryService)(ɵɵinject(SvgLoader), ɵɵinject(PLATFORM_ID), ɵɵinject(SERVER_URL, 8), ɵɵinject(DOCUMENT, 8));
};
SvgIconRegistryService.ɵprov = ɵɵdefineInjectable({
...
SvgIconComponent.ɵfac = function SvgIconComponent_Factory(t) {
  return new (t || SvgIconComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(KeyValueDiffers), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(SvgIconRegistryService), ɵɵdirectiveInject(ChangeDetectorRef));
};
...
AngularSvgIconModule.ɵmod = ɵɵdefineNgModule({
  type: AngularSvgIconModule,
  declarations: [SvgIconComponent],
  imports: [CommonModule],
  exports: [SvgIconComponent]
});
AngularSvgIconModule.ɵinj = ɵɵdefineInjector({
  imports: [[CommonModule]]
});
(() => {
